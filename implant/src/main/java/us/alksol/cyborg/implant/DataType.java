...
public final class DataType {
	...
	public enum Major {
		...
		private Major(boolean isContainer, boolean isCompleteDataItem, boolean isIndeterminateAllowed, boolean isPossiblyFollowedByBinaryData) {
	...
	public long getValue() {
		if (value < 0) {
			throw new ArithmeticException("value is negative or does not fit in a signed long");
		}
		return value;
	}
	...
	public int getValueAsInt() {
		if (value < 0 || value > Integer.MAX_VALUE) {
			throw new ArithmeticException("integral value does not fit within a signed 32-bit integer");
		}
	...
	void assertMajorType(Major... expected) throws CborIncorrectMajorTypeException {
	...
	public static DataType negativeUnsignedLongValue(long value2) {
		// TODO Auto-generated method stub
		return null;
	}

	public static DataType unsignedLongValue(long value2) {
		// TODO Auto-generated method stub
		return null;
	}
}